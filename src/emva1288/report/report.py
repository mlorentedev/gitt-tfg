...
-------------------------------------------------------------------------------
Description:    Functions to report generation
-------------------------------------------------------------------------------    
"""
#%% Imports
import jinja2
...
class Report1288(object):
    ...
    def _plots(self, results, id_):
        ...
        will be saved in tiff format in the output directory.
        """
        names = {}
        ...
        for plt_cls in EVMA1288plots:
            ...
            fname2 = plt_cls.__name__ + '.tiff'
            figure.savefig(os.path.join(savedir, fname))
            figure.savefig(os.path.join(savedir, fname2))
